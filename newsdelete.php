...
<nav class="headMenu">
 ...
 <div class="mainmenu"><a  class="activ"  href="news.php">НОВОСТИ</a></div>
...
<?php require('controllers/newsdelete.php'); ?>
</p>
<form method="post" action="">
<input type="text" class="pol" id="id" name="id" placeholder="Введите id удаляемой новости"><br>

<br>

<br>
<br>
<input type="submit" value="Удалить" class="buttons" name="submit">
